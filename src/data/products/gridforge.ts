  ...
  downloads: [
    {
      ...
      href: "https://github.com/xdcoderz/gridforge-releases/releases/download/v0.1.0/GridForge-Setup-0.1.0.exe",
      size: "24 MB",
      sha256:
    ...
    },
    {
      ...
      href: "https://github.com/xdcoderz/gridforge-releases/releases/download/v0.1.0/GridForge-0.1.0-win-x64.zip",
      size: "32 MB",
      sha256:
