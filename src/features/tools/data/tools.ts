...
export const tools: ToolDefinition[] = [
  ...
  },
  {
    ...
    inputs: ["Workflow type", "Frequency", "Weekly effort", "People", "Risk", "Current tools"],
    outputs: ["Priority score", "Recoverable time", "System recommendation", "First move"],
    nextSteps: [
      "Add a shareable audit report.",
      "Benchmark results by industry.",
      "Connect qualified results to a scoped discovery brief.",
    ],
  },
  {
    ...
    inputs: ["Market topic", "Target customer", "Platform preference", "Build ambition"],
    outputs: ["10 project ideas", "MVP scope", "Monetization", "Validation test"],
    nextSteps: [
      "Add optional AI expansion for shortlisted ideas.",
      "Allow users to save and compare a shortlist.",
      "Prefill the brief from weekly market digest events.",
    ],
  },
  {
